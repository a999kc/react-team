...
const ReturnButton: React.FC<{ onClick: () => void }> = ({ onClick }) => {
    return (
      <button className="user-single-return" onClick={onClick}>
        Назад
      </button>
    );
  };

const LogoutIcon: React.FC<{ onClick: () => void }> = ({ onClick }) => {
  return (
    <div className="logout-icon" onClick={onClick}>
...
const ReturnIcon: React.FC<{ onClick: () => void }> = ({ onClick }) => {
    return (
      <div className="return-icon" onClick={onClick}>
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export { LogoutButton, LogoutIcon, ReturnButton, ReturnIcon};
